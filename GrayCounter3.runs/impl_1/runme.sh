...
HD_PWD='D:/XilinxProjekty/GrayCounter3/GrayCounter3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GrayCounter3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GrayCounter3.tcl -notrace
