...
HD_PWD='D:/XilinxProjekty/GrayCounter3/GrayCounter3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GrayCounter3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GrayCounter3.tcl
